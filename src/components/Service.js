            ...
            <ul>
              ...
              {/* <li className="wow fadeInLeft" data-wow-duration="1s">
                <div className="list_inner tilt-effect">
                  ...
                  <div className="text">
                    <p>
                    Creating a complete website that works 
                    interactively and has a pure domain on it and is 
              ...
              >
                <div className="list_inner tilt-effect">
                  ...
                  <div className="text">
                    <p>
                    I can create a complete UI design to help the programmer
